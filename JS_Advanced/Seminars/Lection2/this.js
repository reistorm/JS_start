...
arrowFunction(); // Выводит контекст выполнения, который был определен во время 
// создания функции (лексический контекст)
...
obj.regularMethod(); // вывод объект obj т.к. метод вызывается на объекте obj
