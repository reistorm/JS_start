// На странице есть список элементов, каждый из которых
// имеет атрибут data-price, содержащий цену товара
// Создайте функцию, которая принимает максимальную
// цену и скрывает все элементы с ценой выше указанного
// значения
...
// На странице есть список элементов, каждый из которых 
// имеет атрибут data-rating, содержащий рейтинг товара.
// Создайте функцию, которая сортирует элементы в порядке
// убывания рейтинга и переставляет их на странице в соответствии 
// с новым порядком
